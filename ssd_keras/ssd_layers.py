...
from keras.layers import BatchNormalization, Convolution2D, Activation, add, InputSpec 
...
class PriorBox(Layer):
    ...
    def call(self, x, mask=None):
        ...
        # print(K.int_shape(prior_boxes_tensor)) # for debugging purpose
...
def Residual_Block(num_filters_out, prev_layer):
    ...
    Args:
      num_filters_inp: number of channels/filters coming in, from input or previous layer
      num_maps_out: how many output channels/filters this block will produce
