...
from keras.applications import InceptionResNetV2, VGG19
...
base_model = SSD_300(input_shape, num_classes=NUM_CLASSES)

# base_model = VGG19(input_shape=input_shape, pooling='max', weights='imagenet', include_top=False)
# base_model = InceptionResNetV2(input_shape=input_shape, pooling='max', weights='imagenet', include_top=False)
base_model.summary()
